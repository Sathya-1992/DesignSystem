...
export class QuickStyleService {
  ...
  designSystem: { styles: { ":root": { [key in string]: {} }, "html": {}, "variable": { [key in string]: {} }, all: { [key in string]: {} }, group: { [key in string]: {} } }, componentList: {}[] } = {
    styles: {
      ...
      "variable": {
        "color-palette": {
          "--color1-bg-color": "#007bff",
          "--color1-hov-color": "#1D4ED8",
          "--color1-act-color": "#1e40af",
          "--color2-bg-color": "#6c757d",  
          "--color2-hov-color": "#dfe1e6", 
          "--color2-bdr-color": "#8D8D8D",
          "--lightcolor2-bg-color": "#F4F4F4",
          "--lightcolor2-hov-color": "#ebecf0",
          "--color3-bg-color": "#eac54f",
          "--color3-hov-color": "#d4a72c",
          "--color3-act-color": "#bf8700",
          "--color4-bg-color": "#6200EE",
          "--color4-outlined-fg-color": "#814dde",
          "--color4-outlined-bdr-color": "#e1cbff",
          "--color4-outline-hov-color": "#f4eaff",
          "--color4-outline-bdr-hov-color": "#c69eff",
          "--color4-outline-act-color": "#e1cbff",
          "--color5-bg-color": "#28a745",
          "--color5-hov-color": "#218838",
          "--color5-act-color": "#1e7e34",
          "--color6-bg-color": "#dc3545",
        ...
        "background-color": {
          ...
          "--input-grp-bdr-color": "var(--color1-bg-color)",
          "--input-grp-hov-color": "var(--color1-bg-color)",
          "--input-grp-foc-color": "var(--color1-bg-color)",
          // "--input1-bg-color" : "var(--light-bg-color)",
          // "--input1-fg-color" : "var(--dark-fg-color)",
          "--input1-hov-color": "var(--color2-hov-color)",
          // "--input2-bg-color" : "var(--light-bg-color)",
          // "--input2-fg-color" : "var(--dark-fg-color)",
          // "--input2-hov-color" : "var(--color1-bg-color)",
          "--input3-bg-color": "var(--lightcolor2-bg-color)",
          // "--input3-fg-color" : "var(--dark-fg-color)",
          "--input3-hov-color": "var(--lightcolor2-hov-color)",
          "--input3-bdr-color": "var(--color2-bdr-color)",
          "--input3-foc-color": "var(--color4-bg-color)",
          "--input4-bg-color": "var(--lightcolor2-bg-color)",
          // "--input4-fg-color" : "var(--dark-fg-color)",
          "--input4-hov-color": "var(--lightcolor2-hov-color)",
          "--input4-bdr-color": "var(--lightcolor2-bg-color)",
          "--input4-foc-color": "var(--light-bg-color)",
          "--input5-bg-color": "var(--lightcolor2-bg-color)",
          // "--input5-fg-color" : "var(--dark-fg-color)",
          "--input5-hov-color": "var(--lightcolor2-hov-color)",
          "--input5-bdr-color": "var(--color2-hov-color)",
          "--input5-foc-color": "var(--light-bg-color)",
          "--input5-foc-bdr-color": "var(--color1-bg-color)",

          "--button-grp-bg-color": "var(--color1-bg-color)",
          "--button-grp-fg-color": "var(--light-fg-color)",
          "--primary-btn-bg-color": "var(--color1-bg-color)",
          "--primary-btn-hov-color": "var(--color1-hov-color)",
          "--primary-btn-act-color": "var(--color1-act-color)",
          "--secondary-btn-bg-color": "var(--color3-bg-color)",
          "--secondary-btn-hov-color": "var(--color3-hov-color)",
          "--secondary-btn-act-color": "var(--color3-act-color)",
          "--secondary-btn-fg-color": "var(--dark-fg-color)",
          "--success-btn-bg-color": "var(--color5-bg-color)",
          "--success-btn-hov-color": "var(--color5-hov-color)",
          "--success-btn-act-color": "var(--color5-act-color)",
          "--add-btn-outlinedbg-color": "var(--light-bg-color)",
          "--add-btn-outlinedfg-color": "var(--color4-outlined-fg-color)",
          "--add-btn-outlinebdr-color": "var(--color4-outlined-bdr-color)",
          "--add-btn-outline-hov-color": "var(--color4-outline-hov-color)",
          "--add-btn-outline-bdrhov-color": "var(--color4-outline-bdr-hov-color)",
          "--add-btn-outline-act-color": "var(--color4-outline-act-color)",

          "--radio-grp-bg-color" : "var(--light-bg-color)",
          "--radio-grp-bdr-color": "var(--dark-bdr-color)",
          "--radio-grp-bdr-hov-color": "var(--color1-hov-color)",
          "--color6-label-color": "var(--color6-bg-color)",
          "--color5-label-color": "var(--color5-bg-color)",
          "--color1-label-color": "var(--color1-bg-color)",

          "--switch-grp-bg-color": "var(--light-bg-color)",
          "--slider-offbg-color": "var(--color6-bg-color)",
          "--slider-onbg-color": "var(--color5-bg-color)"
      ...
      group: {
        ...
        radioGroup: {
          default: {
            ...
            "cursor": "pointer",
            "background-color" : "var(--radio-grp-bg-color)"
          },
          hover: {
            "border": "var(--spacing-s) solid var(--radio-grp-bdr-hov-color)"
          },
          focus: {
    ...
    componentList: [
      ...
      },
      {
        ...
        specific: {
          ...
          checked: {
            options : {  
              red : { "background-color": "var(--color6-label-color)"},
              green : {"background-color": "var(--color5-label-color)"},
              blue : {"background-color": "var(--color1-label-color)"}
            }  
          },
          focus: {
